...
--multi_gpu \
--task=g1_deepmimic_root_heightfield_no_history_dagger --headless --env.terrain.n_rows=1 --num_envs=4096 --run_name g1_deepmimic_distill --wandb_note "videomimic_stage_3" \
