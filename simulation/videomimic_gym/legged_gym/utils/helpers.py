...
def get_args():
    custom_parameters = [
        ...
        {"name": "--jit_policy_path", "type": str, "help": "Path to a TorchScript policy to run directly in play.py. Skips loading a training checkpoint."},
        {"name": "--zero_policy", "action": "store_true", "default": False, "help": "Run play.py with zero actions instead of a checkpoint policy."},
